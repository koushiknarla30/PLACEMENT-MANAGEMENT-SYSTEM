            ...
            <% 
                ...
                try {
                    ...
                    while (rs.next()) {
                        ...
                        out.println("<p>"+ rs.getString("company_name") + "</p>");
                        out.println("<br>");
                        out.println("<p>" + rs.getString("job_title") + "</p>");
                        out.println("<br>");
                        out.println("<p>" + rs.getString("skills") + "</p>");
                        out.println("<br>");
                        out.println("<p>" + rs.getString("preference_criteria") + "</p>");
                        out.println("<br>");
                        out.println("<p>" + rs.getString("package") + "</p>");
